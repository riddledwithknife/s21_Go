...
import (
	...
	operations2 "day04/ex01/restapi/operations"
...
//go:generate swagger generate server --target ../../swagger-api --name CandyServer --spec ../swagger.yaml --principal interface{}
